...
var cssMin = require('glup-clean-css');
...
var cfg={
	...
	// our clietn application source code src globs and build paths
	...
	apiUrl: { dev: "http://localhost:3000",
			  prd: "https://arcane-anchorage-50842.herokuapp.com/"},
...
var devResourcePath = [
	...
	gulp.task("dist:assets", ["build"], function(){
		return gulp.src(cfg.root_html.src).pipe(debug())
			...
			.pipe(gulp.dest(disPath)).pipe(debug());
